...
const createArticles = () => {
 ...
 />
 <h2>${article.title}</h2>
 <p class="article-author">${article.author} - ${article.category} - ${new Date(
        article.createdAt
 ...
 <div class="btn btn-primary" data-id=${article._id}>Modifier</div>
   <div class="btn btn-danger" data-id=${article._id}>Supprimer</div>
 </div>
    `;
      return articleDOM;
    });
